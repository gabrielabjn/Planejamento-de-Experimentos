...
SQ<-(1/K)*sum(x$obs^2)-(sum(x$obs)^2)*1/(J*K)
SQ
QM<-SQ/GL_2
QM
QM/QM6
...
SQ<-(1/K)*sum(x$obs^2)-(sum(x$obs)^2)*1/(I*K)
SQ
QM<-SQ/GL_1
QM
QM/QM6
